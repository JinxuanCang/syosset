SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    connect_src: %w('self' ws://localhost:3000 accounts.google.com www.google-analytics.com
      translate.googleapis.com cdn.jsdelivr.net), # jsdelivr cdn for simplemde spellchecking
